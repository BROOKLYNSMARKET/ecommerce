    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preco', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0'), default_currency='BRL', max_digits=6)),
                ('imagem', models.ImageField(default='SEM IMAGEM', upload_to=None)),
                ('autor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('categoria', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='marketdb.categoriaproduto')),
            ],
        ),
    ]
